...
_TEMPLATE_DESCRIPTIONS = {
    ...
    "numba_installed": "a request, not a fact: set False to run without the JIT kernels even where numba is installed; True is cleared at runtime if it is not (unused on the C backend, kept for round-trip parity)",
    ...
    "atol_large_LT": "solve_ivp absolute tolerance for the LT era of every network (the name is historical)",
    "rescale_nuclear_rates": "accepted but read by nothing; vary a rate with p_<reaction> or delta_<reaction>",
