...
for **primat version 0.3.3** (package renamed from `PyPRIMAT`/`pyprimat`;
...
| File | Purpose |
|------|---------|
| `primat_documentation_v0.3.3.tex` | The LaTeX source (usage, plasma thermodynamics, weak interactions, nuclear reactions, sensitivity, appendices A–G). |
...
| `primat_documentation_v0.3.3.pdf` | Compiled output. |
...
cd manual
latexmk -pdf primat_documentation_v0.3.3.tex
```
