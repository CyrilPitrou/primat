...
%  code has changed.
%
%  Compile with:   latexmk -pdf primat_documentation_v0.3.3.tex
%             or:  pdflatex primat_documentation_v0.3.3.tex  (x3 for refs)
% =====================================================================
...
\title{\textbf{primat}\\[2pt]
       ...
       \normalsize\textit{Documentation for primat version 0.3.3}}
\author{Cyril Pitrou}
\date{\today}
...
version 0.3.3}: the package was renamed from \code{pyprimat} to \code{primat}
