...
the QED corrections are loaded from \code{data/plasma/QED\_*.txt} or computed
...
recompute\_qed\_corrections & False & Recompute and overwrite \code{data/plasma/QED\_*.txt}. \\
...
background grid. Results are cached in \code{data/weak/} behind a configuration
...
weak\_rate\_cache       & True  & Reuse the fingerprinted \code{data/weak/} cache when valid. \\
\bottomrule
\end{tabular}
\end{center}
...
two columns of \code{data/plasma/QED\_*.txt}:
\begin{align}
